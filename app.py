...
def home():
    # Initial rendering
    result = [{'model':'Decision Tree   (79%) ', 'prediction':' '},
              {'model':'Deep Learning   (76%)', 'prediction':' '},
              {'model': 'K-nearest Neighbors   (78%) ', 'prediction': ' '},
              {'model': 'Logistic Regression   (70%) ', 'prediction': ' '},
              {'model': 'Random Forest   (83%) ', 'prediction': ' '},
              {'model': 'SVM   (78%) ', 'prediction': ' '},
              {'model': 'XGBoost   (76%) ', 'prediction': ' '}]
...
def predict():
    ...
    result = [
            {'model':'Decision Tree   (79%) ', 'prediction':predl[0]},
            {'model':'Deep Learning   (76%) ', 'prediction':predl[1]},
            {'model': 'K-nearest Neighbors   (78%) ', 'prediction': predl[1]},
            {'model': 'Logistic Regression   (70%) ', 'prediction': predl[2]},
            {'model': 'Random Forest   (83%) ', 'prediction': predl[3]},
            {'model': 'SVM   (78%)', 'prediction': predl[4]},
            {'model': 'XGBoost   (76%)', 'prediction': predl[5]}
            ]
